          ...
          <div className="bg-white p-5 rounded-md shadow-xl  md:pb-10 space-y-8">
            ...
            <div className="flex justify-between p-3">
              <div className="flex flex-col md:flex-row gap-2">
                ...
                <div className="text-lg text-faintGreen">
                  Software Developer
                </div>
              </div>

              <div className="flex justify-center items-center">
                <button className="bg-red-500 text-white font-semibold px-4 py-2 md:py-2 md:px-9 rounded-md border border-slate-300">
                  Reject
                </button>
              </div>
            </div>
